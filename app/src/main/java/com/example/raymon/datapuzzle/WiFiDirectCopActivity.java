 ...
 */
public class WiFiDirectCopActivity extends Activity implements ChannelListener, DeviceActionListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        discover_peers_btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (!isWifiP2pEnabled) {
                    Toast.makeText(WiFiDirectCopActivity.this, R.string.p2p_off_warning,
                ...
                manager.discoverPeers(channel, new WifiP2pManager.ActionListener() {
                    ...
                    public void onSuccess() {
                        Toast.makeText(WiFiDirectCopActivity.this, "Discovery Initiated",
                                Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onFailure(int reasonCode) {
                        Toast.makeText(WiFiDirectCopActivity.this, "Discovery Failed : " + reasonCode,
                                Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    public void connect(WifiP2pConfig config) {
        ...
        manager.connect(channel, config, new ActionListener() {
            ...
            public void onFailure(int reason) {
                Toast.makeText(WiFiDirectCopActivity.this, "Connect failed. Retry.",
                        Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        if (manager != null) {
            ...
            if (fragment.getDevice() == null
                ...
                manager.cancelConnect(channel, new ActionListener() {
                    ...
                    @Override
                    public void onSuccess() {
                        Toast.makeText(WiFiDirectCopActivity.this, "Aborting connection",
                                Toast.LENGTH_SHORT).show();
                    }

                    @Override
                    public void onFailure(int reasonCode) {
                        Toast.makeText(WiFiDirectCopActivity.this,
